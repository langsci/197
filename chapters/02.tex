...
\eabox{$$
{\acute{{\theta}} }_{i}={2{\pi f}}_{i}+{F}_{{\varphi S}}\left(S,{\theta} _{i}\right)+\sum _{j}{{{\Phi} _{{ij}}F}_{\varphi} \left({\varphi} _{{ij}},{e}_{i},{e}_{j}\right)}
$$}

\eabox{$$
{\acute{{e}}}_{i}=\text{Ê}\left[\overrightarrow{{\theta}} ,\overrightarrow{{e}}\right]+{F}_{{eS}}\left(S,{e}_{i}\right)+\sum _{j}{{{\varepsilon} _{{ij}}F}_{e}\left({\varphi} _{{ij}},{e}_{i},{e}_{j}\right)}
$$}
