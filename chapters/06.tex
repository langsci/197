...
\lspbottomrule
\end{tabularx}
\caption{The coherence hierarchy.}\label{tab:6:1}
\end{table}
...
\eabox[-.6\baselineskip]{
  \parbox[t]{.4\textwidth}{
    \textbf{Center embedding}\\
    I saw ...
    \ea   a frog a cat chased.                      
    \ex a frog a cat a dog bit, chased.  
    \ex a frog a cat a dog a bee stung bit chased.
    \z
  }~~%
  \parbox[t]{.4\textwidth}{
    \textbf{Tail recursion}\\
    I saw ...
    \ea a cat who chased a frog.
    \ex a dog who bit a cat, who chased a frog.
    \ex a bee who stung a dog who bit a cat who chased a frog
    \z
  }
}
...
\eabox[-.6\baselineskip]{
  \parbox[t]{.4\textwidth}{
    \textbf{Center embedding}
    \ea Al, who Bo likes.                                
    \ex Al, who Bo, who Cam likes, likes.                
    \ex Al, who Bo, who Cam, who Dee likes, likes, likes.
    \z
  }~~%
  \parbox[t]{.4\textwidth}{
    \textbf{Tail recursion}
    \ea Bo, who likes Al.
    \ex Cam, who likes Bo, who likes Al.
    \ex Dee, who likes Cam, who likes Bo, who likes Al.
    \z
  }%
}
